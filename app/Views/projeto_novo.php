                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 border-t border-gray-100 pt-4 mt-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                            ...
                            <div class="md:col-span-1"><label class="text-xs text-gray-600">Zona</label><select name="zona" id="zona" class="w-full border p-2 rounded bg-white">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                        ...
                        <div id="div_travessia" class="hidden">
                            <label class="block text-xs font-medium text-gray-700 mb-1">Tipo de Travessia</label>
                            <select name="travessia" id="travessia" class="w-full border-gray-300 rounded text-sm p-2 bg-white border focus:ring-eletblue focus:border-eletblue">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleTravessia() {
                ...
                // Ajuste aqui conforme está escrito no value do seu select de ramal
                // Pode ser 'Subterraneo', 'subterraneo', 'Subterrâneo'... verifique o value exato.
                const valorRamal = ramalSelect.value.toLowerCase();

                if (valorRamal.includes('subterrane') || valorRamal.includes('subterrâneo')) {
                    // Se for subterrâneo, ESCONDE
                    travessiaDiv.classList.add('hidden');
                    travessiaInput.value = ''; // Limpa a seleção para não enviar lixo no JSON
                } else {
                    // Se for aéreo, MOSTRA
                    travessiaDiv.classList.remove('hidden');
                }
            }
